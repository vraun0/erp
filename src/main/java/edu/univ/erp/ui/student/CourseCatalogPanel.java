...
public class CourseCatalogPanel extends AbstractStudentPanel {
    ...
    public CourseCatalogPanel(StudentService studentService, String studentId) {
    ...
    private JPanel createCourseCard(CourseSectionView view) {
        ...
        card.setLayout(new MigLayout("fillx, wrap, insets 0", "[grow]", "[]12[]8[]6[]6[]6[]6[]16[]"));
    ...
    private void addDetailRow(JPanel parent, String label, String value) {
        ...
        row.add(labelComp, "growx 0, width 120:120:");
    ...
    private void registerForSection(int sectionId) {
        try {
            studentService.registerForSection(Integer.parseInt(studentId), sectionId);
