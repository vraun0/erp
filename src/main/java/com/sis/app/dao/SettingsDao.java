...
public class SettingsDao {
    private static final String SELECT_MAINTENANCE = "SELECT maintenance FROM settings LIMIT 1";
    private static final String UPDATE_MAINTENANCE = "UPDATE settings SET maintenance = ?";
